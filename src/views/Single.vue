<template>
    <section class="ab-info-main py-md-1 py-4 main_content single">
                    ...
                    <div class="row">
                        ...
                        <div class="desc1-right col-md-6 pl-lg-4">
                            ...
                            <ul>
                                ...
                                <li class="li-product"><span><b>Актеры:</b> Арнольд Шварценеггер, Маккензи Дэвис,
                                ...
                                <li class="li-product"><span><b>Премьера в мире:</b> 23 октября 2019</span>
                                </li>
                                <li class="li-product">
                                    <span><b>Бюджет:</b> $185 000 000</span></li>
                                <li class="li-product">
                                    <span><b>Сборы в США:</b> $61 150 256</span></li>
                                <li class="li-product"><span><b>Сборы в мире:</b> $250 369 693</span>
                                </li>
                                <li class="li-product">
                                    <a href="#"><b>Рейтинг:</b>
                                        <span class="fa fa-star" aria-hidden="true"
