                ...
                <div class="row footer-top">
                    ...
                    <div class="col-lg-8 footer-right">
                        <div class="w3layouts-news-letter">
                            ...
                            <p class="editContent">By subscribing to our mailing list you will always get latest news
                                and
                                updates from us.</p>
                            <form action="#" method="post" class="w3layouts-newsletter">
                                <input type="email" name="Email" class="editContent" placeholder="Enter your email..."
                                       required="">
                        ...
                        <div class="row mt-lg-4 bottom-w3layouts-sec-nav mx-0">
                            ...
                            <div class="col-md-4 footer-grid_section_w3layouts my-md-0 my-5">
                                <h3 class="footer-title text-uppercase text-wh mb-lg-4 mb-3 editContent">Contact
                                    Info</h3>
        ...
        <div class="cpy-right py-3">
            <div class="container">
                <div class="row">
                    ...
                    <!-- move top icon -->
                    <a href="#" class="move-top text-right col-md-2"><span class="fa fa-long-arrow-up"
